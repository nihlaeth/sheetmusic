...
#(define color-mapping
  (list
    (cons (ly:make-pitch 0 0 -1/2) (x11-color 'DarkRed))
    (cons (ly:make-pitch 0 0 0) (x11-color 'DarkRed))
    (cons (ly:make-pitch 0 0 1/2) (x11-color 'DarkRed))
    (cons (ly:make-pitch 0 1 -1/2) (x11-color 'DarkRed))
    (cons (ly:make-pitch 0 1 0) (x11-color 'DarkRed))
    (cons (ly:make-pitch 0 1 1/2) (x11-color 'DarkRed))
    (cons (ly:make-pitch 0 2 -1/2) (x11-color 'DarkRed))
    (cons (ly:make-pitch 0 2 0) (x11-color 'DarkRed))
    (cons (ly:make-pitch 0 2 1/2) (x11-color 'DarkRed))
